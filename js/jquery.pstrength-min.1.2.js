    ...
    A.extend(A.fn, {
        pstrength:function (B) {
            var B = A.extend({
                ...
                scores:[10, 15, 30, 40],
                common:['123456', '1234567', '12345678', '123456789', '1234567890', 'password', 'secret', 'liverpool', 'letmein', 'qwerty', 'iloveyou', 'princess', 'abc123', 'monkey' ],
                minchar:6
            }, B);
            return this.each(function () {
                ...
                A(this).keyup(function () {
                    A.fn.runPassword(A(this), A(this).val(), C, B)
                })
            })
        },
        runPassword:function (input, D, F, C) {
            ...
            if (nPerc == -200) {
                ...
                if (nPerc < 0 && nPerc > -199) {
                    strColor = "#f00";//"#ccc";
                    strText = "Too short: " + "Minimum number of characters is " + C.minchar;
                    A(B).css({
                        width:.05 * input.width()
                    })
